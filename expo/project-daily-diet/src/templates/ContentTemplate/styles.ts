...
export const StyledContainer = styled.View<typeDefault>`
  ${({ theme, ...props }) => css`
    ...
    ${props.radius &&
    css`
      border-radius: ${props.radius.radius ? props.radius.radius : 0}px;
      border-top-left-radius: ${props.radius.top?.left
        ? props.radius.top?.left
        : 0}px;
      border-top-right-radius: ${props.radius.top?.right
        ? props.radius.top?.right
        : 0}px;
      border-bottom-left-radius: ${props.radius.bottom?.left
        ? props.radius.bottom?.left
        : 0}px;
      border-bottom-right-radius: ${props.radius.bottom?.right
        ? props.radius.bottom?.right
        : 0}px;
    `}

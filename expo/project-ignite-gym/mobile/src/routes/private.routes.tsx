...
export type AppNavigatorRoutesProps =
  BottomTabNavigationProp<AppPrivateRoutesType>;

const { Navigator, Screen } = createBottomTabNavigator<AppPrivateRoutesType>();

export function AppPrivateRoute() {
